...
@export var characters_portraits: Array[CharacterPortraitResource]
...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		for character_res in characters_portraits:
			if character_res.dialogue_name == dialogue_line.character.to_lower():
				character_portrait.texture = character_res.texture
